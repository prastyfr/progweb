    ...
    <div class="row no-gutter mr-2">
      ...
      <div class="col-md-6">
        ...
        <thead class="thead-dark">
          <tr>
            <th scope="col"><font face="tahoma" size="2.5">No Faktur</font></th>
            <th scope="col"><font face="tahoma" size="2.5">Tanggal</font></th>
            <th scope="col"><font face="tahoma" size="2.5">Kode Pelanggan</font></th>
        ...
        <?php foreach ($transaksi as $row) : ?>
          ...
          <td><?= $row["kode_pelanggan"]; ?></td>
           <td>
            <a href="ubahtransaksi.php?id=<?= $row["id"];?> "><button type="button" class="btn btn-primary btn-sm">Ubah</button></a> |
            <a href="hapustransaksi.php?id=<?= $row["id"];?> "><button type="button" class="btn btn-danger btn-sm">Hapus</button></a>
          </td>
        </tr>
      <?php endforeach; ?>
      </table>
        ...
        <div class="card my-2">
          ...
          <div class="card-body">
            <form action="" method="POST">
              ...
              <div class="form-group ">
                <label>Tanggal</label>
                <input type="date" class="form-control" name="tgl" placeholder="Kode Barang">
              </div>
              <div class="form-group ">
