      ...
      <div class="col-md-6">
        ...
        <thead class="thead-dark">
          <tr>
            ...
            <th scope="col"><font face="tahoma" size="2.5">Quantity</font></th>
        ...
        <?php foreach ($detail as $row) : ?>
          ...
          <td><?= $row["qty"]; ?></td>
           <td>
            <a href="ubahdetail.php?id=<?= $row["id"];?> "><button type="button" class="btn btn-primary btn-sm">Ubah</button></a> |
            <a href="hapusdetail.php?id=<?= $row["id"];?> "><button type="button" class="btn btn-danger btn-sm">Hapus</button></a>
          </td>
        </tr>
      <?php endforeach; ?>
      </table>
