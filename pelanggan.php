...
<html lang="en">
  ...
  <link rel="stylesheet" href="bootstrap/css/datatables-b4.css">
    ...
    <div class="row no-gutter mr-2">
      ...
      <div class="col-md-7">
        ...
        <thead class="thead-dark">
          <tr>
            <th scope="col"><font face="tahoma" size="2.5">Kode Pelanggan</th>
      ...
      <?php foreach ($pelanggan as $row) : ?>
        <tr>
          ...
          <td><?= $row["telepon"]; ?></td>
          <td><?= $row["alamat"]; ?></td>
          <td><img src="img/<?php echo $row["foto"]; ?>" width="60"></td>
           <td>
            <a href="ubahpelanggan.php?id=<?= $row["id"];?> "><button type="button" class="btn btn-primary btn-sm">Ubah</button></a> |
            <a href="hapus.php?id=<?= $row["id"];?> "><button type="button" class="btn btn-danger btn-sm">Hapus</button></a>
          </td>
        </tr>
      <?php endforeach; ?>
      </table>
          ...
          <div class="card-body">
            <form action="" method="POST" enctype="multipart/form-data">
              <div class="form-group ">
                ...
                <input type="text" class="form-control" name="kode_pelanggan" placeholder="Kode Barang">
              </div>
              <div class="form-group ">
                <label>Nama</label>
              ...
              <div class="form-group ">
                ...
                <input type="enum" class="form-control" name="JK" placeholder="Jenis Kelamin">
              </div>
              <div class="form-group ">
                <label>Telepon</label>
